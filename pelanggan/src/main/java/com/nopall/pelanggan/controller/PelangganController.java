package com.nopall.pelanggan.controller;
...
import com.nopall.pelanggan.service.PelangganService;
...
public class PelangganController {
    ...
    @PostMapping
    public Pelanggan createProduk(@RequestBody Pelanggan pelanggan){
